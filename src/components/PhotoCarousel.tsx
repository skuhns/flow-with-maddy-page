...
const PhotoCarousel = () => {
  ...
  return (
    <section className="py-8 md:py-8 bg-warm-cream">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="font-display text-4xl md:text-6xl font-medium text-foreground">
            Professional <span className="italic text-gradient">Playtime</span>
          </h2>
          ...
          <div className="overflow-hidden rounded-2xl" ref={emblaRef}>
            <div className="flex gap-4">
              {photos.map((photo, i) => (
                <div
                  key={i}
                  className="flex-[0_0_80%] md:flex-[0_0_45%] min-w-0"
                >
